...
root.title('Smart Attendance System(author : SATKIRTI)')
...
root['bg'] = 'RosyBrown2' # background

lbl=Label(root,text ="SMART ATTENDANCE SYSTEM",fg ='navy',font =("cursive", 70),bg='PeachPuff2')
lbl.place(x=100,y=10)

lbl1=Label(root,text ="Choose the options",fg ='dodger blue' , font =("times new roman", 30),bg='PeachPuff2')
lbl1.place(x=50,y=170)

lbl2=Label(root,text ="Enroll the faces and encode the faces",fg ='brown4' , font =("times new roman", 30),bg='PeachPuff2')
lbl2.place(x=145,y=270)

lbl3=Label(root,text ="Start attendance",fg ='brown4' , font =("times new roman", 30),bg='PeachPuff2')
lbl3.place(x=145,y=340)

lbl16=Label(root,text ="Reset all the things",fg ='brown4' , font =("times new roman", 30),bg='PeachPuff2')
...
def setTextInput1():
    ...
    if (mailid.get() == ""):
        ...
        lbl14=Label(root,text ="Send the mail",fg ='red3' , font =("times new roman", 30),bg='PeachPuff2')
...
lbl11=Label(root,text ="Send database via mail",fg ='dark green' , font =("times new roman", 40),bg='PeachPuff2')
lbl11.place(x=1200,y=690)

lbl14=Label(root,text ="Enter email id",fg ='dark violet' , font =("times new roman", 30),bg='PeachPuff2')
...
def setTextInput2():
    ...
    def setTextInput3():
        ...
        if pass_word == "123": # from here you can change your password
            conn = sqlite3.connect('attendance_database.db')
            curs = conn.cursor()
...
lbl17=Label(root,text ="Generate database",fg ='dark violet' , font =("times new roman", 30),bg='PeachPuff2')
